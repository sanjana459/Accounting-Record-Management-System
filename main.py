...
def add_menu(window):
    ...
    about_menu.add_command(label="Anushka Roy",
                           command=lambda: web.open("https://www.linkedin.com/in/anushka-roy-492a40243/"))
    about_menu.add_command(label="G Sanjana Reddy",
                           command=lambda: web.open("https://www.linkedin.com/in/g-sanjana-reddy-949878243/"))
